        ...
        <div class="main-head for-video-head">
            <div class="container">
                <div class="intro-text">
                    ...
                    <div class="for-start-btn"> <!--<a href="#second-sec" class="page-scroll">-->
                         <?php 
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="choose-box">
                                    <img src="<?php echo get_template_directory_uri() . '/'; ?>images/portfolio/chose-1.png" alt="">
                                    <h3>ecommerce</h3>
                                    ...
                                    <ul class="first-box">
                                            ...
                                            <li><a href="drupal-development.html"><img src="<?php echo get_template_directory_uri() . '/'; ?>images/portfolio/web-01.png" alt="drupal development">
                                                <!--<span class="for-sub-page">Read More</span>-->
                                                </a>
                                            </li>
