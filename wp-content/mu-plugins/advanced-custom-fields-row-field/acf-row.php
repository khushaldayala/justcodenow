...
Plugin URI: https://wphippos.com
Description: This is an Add-on to Advanced Custom fields (ACF) for showing multiple ACF fields in a single row on front-end. Great for short text fields or having 2x date fields next to each other. Once activated, 'Row' field will be available under the 'Edit Field Group' section in ACF field types.
Version: 1.0.77
Author: Unihost
...
// If this file is called directly, abort.w
if ( ! defined( 'WPINC' ) ) {
  die;
}
