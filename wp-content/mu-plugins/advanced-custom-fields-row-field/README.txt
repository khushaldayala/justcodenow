...
Tags: acf, advanced-custom-fields, addon, add-on, row, form, display, admin, advanced custom fields, multiple rows
...
This is an Add-on to Advanced Custom fields (ACF) for showing multiple ACF fields in a single row on front-end. Great for short text fields or having 2x date fields next to each other. Once activated, 'Row' field will be available under the 'Edit Field Group' section in ACF field types.

== Description ==

<h3>Display up to 4 Advanced Custom Fields (ACF) fields in a single row on the front-end</h3>
...
__Note__: Works up to ACF 5.9.1
...
1. Choose the number of columns you would want
1. Add your fields below the 'Row Open' option
...
1. 'Row' field will now be available under 'Layout' section in ACF field types
...
1. 'Row' field will be added under 'Layout' section in ACF field types

== Frequently Asked Questions ==

= Is there something cool you would like to add? =
...
2. Finding the Row field

== Changelog ==
= 1.0.77 = 04/10/2020
* Updated the Changelog
* Updated Devs to WP Hippos
* Ensured Compatibility for latest WordPress and Advanced Custom Fields
* Getting Ready to add documentation

= 1.0.72 = 16/10/2017
* Fixed https://wordpress.org/support/topic/1-7-0-1-bug/

= 1.0.71 = 13/10/2017
* Added support for 1 column, some clients asked for it.

= 1.0.7 = 12/10/2017
* Fixed the Tab issue - Thanks @figoware

= 1.0.6 = 09/10/2017
* Fixed the Row not closing issue

= 1.0.5 = 25/11/2016
* Added Screenshots to find the plugin function
